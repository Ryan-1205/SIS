...
<head>
    <meta charset="UTF-8">
    <title>Peminjaman Berhasil - SIS</title>
    ...
    <div class="safe-container">
        <div class="success-card shadow-sm bg-white">
            <div class="success-icon">
                <svg width="40" height="40" fill="none" stroke="currentColor" stroke-width="4" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M5 13l4 4L19 7"></path>
                </svg>
            </div>
            <h3 class="fw-bold text-dark mb-4">Peminjaman Berhasil</h3>
            ...
            <p class="mt-4 mb-4" style="font-size: 14px; color: #555;">
                Harap menjaga dan merawat barang pinjaman agar tetap dalam kondisi baik. Gunakan sesuai ketentuan dan kembalikan tepat waktu. Terima kasih atas kerja samanya.
            </p>
