...
// Inisialisasi status untuk mendeteksi modal popup yang muncul
$status_proses = '';
...
<head>
    ...
    <title>Proses Tambah Aset Barang</title>
    ...
    <style>
        ...
        .btn-tosca:hover { background-color: #15443f; color: white; }
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body text-center py-4">
                    ...
                    <h4 class="mt-3 fw-bold" style="color: #1d5c56;">Berhasil Ditambahkan!</h4>
                    <p class="text-muted mb-0">Aset barang baru <strong><?= htmlspecialchars($nama_barang); ?></strong> telah sukses dimasukkan ke dalam sistem.</p>
                </div>
                <div class="modal-footer justify-content-center border-0 pb-4">
                    <a href="admin_barang.php" class="btn btn-tosca text-decoration-none">OK</a>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header" style="background-color: #dc3545;">
                    <h5 class="modal-title fw-bold">⚠️ Gangguan Sistem</h5>
                </div>
                <div class="modal-body text-center py-4">
                    <span style="font-size: 60px;">❌</span>
                    <h4 class="mt-3 fw-bold" style="color: #dc3545;">Gagal Menyimpan!</h4>
                    <p class="text-muted mb-0">Terjadi kesalahan teknis. Data barang gagal masuk ke database database.</p>
                </div>
                <div class="modal-footer justify-content-center border-0 pb-4">
                    <a href="admin_barang.php" class="btn btn-danger-custom text-decoration-none">Coba Lagi</a>
                </div>
            </div>
        </div>
    </div>
