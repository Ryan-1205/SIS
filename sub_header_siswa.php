...
<div class="safe-container">
    <div class="search-section px-3" style="display: flex; align-items: center;">
        ...
        <?php if ($current_page == 'index.php') : ?>
            <h4 class="search-title" style="margin: 0; white-space: nowrap;">Cari Barang</h4>
        <?php else : ?>
            <a href="index.php" class="back-btn" style="margin-right: 15px; position: relative; z-index: 999; cursor: pointer; display: inline-block;">
        ...
        <form action="list_barang.php" method="GET" class="search-bar" id="searchForm" style="flex-grow: 1; position: relative; z-index: 1;">
