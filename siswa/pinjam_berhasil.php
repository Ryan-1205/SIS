...
// Proteksi Akses: Jika tidak ada session user login, kembalikan ke gerbang login luar
...
$jumlah_item = isset($_GET['count']) ? $_GET['count'] : '0';

// SINKRONISASI FORMAT WAKTU: Menampilkan tanggal dan jam pengajuan secara aktual
...
<head>
    ...
    <title>Pengajuan Berhasil - SIS</title>
...
<body class="bg-light">
    ...
    <div class="safe-container px-3">
        <div class="success-card shadow-sm bg-white" style="max-width: 520px; margin: 60px auto 100px auto; padding: 40px 30px; border-radius: 20px; text-align: center; border: 1px solid #e2f1ee;">
            ...
            <h3 class="fw-bold mb-2" style="color: var(--tosca-tua);">Pengajuan Berhasil!</h3>
            <p class="text-muted small mb-4">Berkas peminjaman digital berhasil dikirim ke antrean lab</p>
            ...
            <div class="mx-auto p-3 mb-4 rounded-3 text-start" style="max-width: 440px; background-color: #f8faf9; border: 1px solid #c4e1db;">
                <div class="row g-0 mb-2 align-items-center">
                    <div class="col-5 fw-bold text-secondary" style="font-size: 14px;">Waktu Ajuan</div>
                ...
                <div class="row g-0 mb-2 align-items-center">
                    <div class="col-5 fw-bold text-secondary" style="font-size: 14px;">Total Aset</div>
                    <div class="col-1 text-center text-muted">:</div>
                    <div class="col-6 fw-bold text-dark" style="font-size: 14px;"><?= htmlspecialchars($jumlah_item) ?> Barang</div>
                </div>
                <div class="row g-0 align-items-center">
                    <div class="col-5 fw-bold text-secondary" style="font-size: 14px;">Status Antrean</div>
                    <div class="col-1 text-center text-muted">:</div>
                    <div class="col-6 fw-bold text-warning" style="font-size: 14px;">⏳ Menunggu Verifikasi</div>
                </div>
            </div>

            <p class="mb-4 text-muted" style="font-size: 13.5px; line-height: 1.6; padding: 0 10px;">
                Permohonan peminjaman Anda telah tercatat menggunakan validasi biometrik wajah. Silakan pantau status persetujuan secara berkala atau hubungi dosen pengawas piket laboratorium terkait agar barang fisik bisa segera diserahterimakan.
            </p>
            ...
            <div class="d-flex justify-content-between gap-3 mt-4 px-2">
                ...
                <a href="list_pinjam.php" class="btn btn-outline-secondary fw-bold py-2 w-50 rounded-pill" style="font-size: 14px;">Keranjang & Status</a>
            </div>
        </div>
    </div>
